...
4. **Launch Among Us:**
   Launch Among Us as you normally would. A console window should appear, indicating that the mod's requirements are being installed.

5. **Wait for Installation:**
   Allow the console window to complete the installation process. This may take a few moments.

6. **Enjoy The Mods:**
   After installation is complete, Among Us will automatically open with the Menu successfully installed.

7. **Access Cheat GUI:**
   By default, you can toggle the cheat GUI on by pressing DELETE on your keyboard.

If you encounter any issues during installation, Join The <a href="https://discord.gg/2Fhwg3XD4W">Discord</a> 
